<?php $__env->startSection('title', 'Surat Keluar | SIMA'); ?>
...
<div class="mb-6 flex justify-between items-center reveal" style="transition-delay: 50ms;">
    <form action="<?php echo e(route('surat-keluar')); ?>" method="GET" class="relative w-full max-w-xl">
        ...
        <?php if(request('search')): ?>
            <a href="<?php echo e(route('surat-keluar')); ?>" class="absolute right-3 top-1/2 -translate-y-1/2 text-muted hover:text-inkRed transition-colors" title="Hapus pencarian">
                <i class="ph ph-x"></i>
            </a>
        <?php endif; ?>
    </form>
            ...
            <tbody class="divide-y divide-borderline bg-surface">
                <?php $__empty_1 = true; $__currentLoopData = $surat; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    ...
                    <tr class="hover:bg-canvas/60 transition-colors align-top">
                        ...
                        <td class="px-4 py-4 whitespace-pre-line break-words border-l border-borderline"><?php echo e($s->tujuan); ?></td>
                            ...
                            <?php if($s->file_pdf): ?>
                                <div class="flex flex-col items-start gap-2">
                                    <button
                                        ...
                                        data-title="Surat Keluar <?php echo e($s->nomor_surat); ?>"
...
<?php echo $__env->make('components.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/resources/views/surat/keluar.blade.php ENDPATH**/ ?>