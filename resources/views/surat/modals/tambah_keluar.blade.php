<dialog id="modalKeluar" class="p-0 rounded-xl border border-borderline bg-surface w-[min(820px,94vw)] max-w-none shadow-xl">
    <div class="p-6 sm:p-8 max-h-[92vh] overflow-y-auto">
        ...
        <form action="{{ route('surat-keluar.store') }}" method="POST" enctype="multipart/form-data" class="flex flex-col gap-5">
            @csrf
            ...
            <div class="rounded-lg border border-borderline overflow-hidden">
                ...
                <div class="p-4 grid grid-cols-1 sm:grid-cols-12 gap-4">
                    <div class="sm:col-span-2 flex flex-col gap-1.5">
                        ...
                        <input type="text" name="nomor_urut" class="input-base" placeholder="Contoh: 155" value="{{ old('nomor_urut') }}" required>
                    </div>
                    ...
                    <div class="sm:col-span-6 flex flex-col gap-1.5">
                        ...
                        <input type="text" name="nomor_surat" class="input-base" placeholder="Nomor surat keluar" value="{{ old('nomor_surat') }}" required>
                    </div>
                </div>
            </div>
            ...
            <div class="flex flex-col gap-1.5">
                ...
                <textarea name="tujuan" rows="3" class="input-base resize-y" placeholder="Nama instansi, pihak, atau alamat tujuan" required>{{ old('tujuan') }}</textarea>
            </div>
            ...
            <div class="flex flex-col gap-1.5">
                ...
                <textarea name="keterangan" rows="2" class="input-base resize-y" placeholder="Contoh: periode, petugas, tindak lanjut, atau catatan lain">{{ old('keterangan') }}</textarea>
            </div>
